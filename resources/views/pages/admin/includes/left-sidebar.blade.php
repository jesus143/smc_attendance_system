 <div class="panel panel-default"> 
    <div class="list-group"> 
      {{-- <a href="{{route("pages.dashboard")}}" class="list-group-item">Dashboard</a> --}}
      <a href="{{route("pages.sms")}}" class="list-group-item">SMS</a>
      <a href="{{route("pages.attendance")}}" class="list-group-item">ATTENDANCE</a> 
      <a href="{{route("event.create.select")}}" class="list-group-item">EVENTS</a>
