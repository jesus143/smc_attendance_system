...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet">
        <div style='float:right' >
            <a href="{{route('personnel.logout')}}">Logout</a>
        </div><br><br>
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <h4 class="blue"> 
                                ...
                                <form method="post" action="{{route('personnel.update', $id)}}" >
                                 <input name="_method" type="hidden" value="PATCH"> 
                                  {{csrf_field()}}    

                                    <div class="profile-user-info">
                                        @foreach($personnelName as  $key => $value)
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> {{str_replace('_', ' ',  ucfirst($key)) }}: </div>  

                                                @if($key == 'Religion Specification') 
                                        ...
                                        @endforeach 
                                        &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="Update" class="alert alert-info" /> 
                                    </div> 
                                    </form>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
